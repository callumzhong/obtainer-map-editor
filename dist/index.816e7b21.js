...
const getCoords = (e)=>{
    ...
    return [
        Math.floor(mouseX / 32),
        Math.floor(mouseY / 32)
    ];
};
const draw = ()=>{
    ...
    layers.forEach((layer)=>{
        Object.keys(layer).forEach((key)=>{
            ...
            ctx.drawImage(puzzleImage, puzzleX * 32, puzzleY * 32, size_of_crop, size_of_crop, positionX * 32, positionY * 32, size_of_crop, size_of_crop);
        });
    });
};
...
const currentImage = localStorage.getItem('image') || 'https://assets.codepen.io/21542/TileEditorSpritesheet.2x_2.png';
